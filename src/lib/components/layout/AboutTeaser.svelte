...
<script lang="ts">
  ...
  name: "George Eliadis",
  role: "Founder & CEO",
  image: "/generated/image-a-headshot-of-a-friendly-professional-ma.webp"
};
</script>
...
<section bind:this={sectionRef} {...props}>
	<div class="section-px section-py container mx-auto">
        ...
        text={`"We built Probook after sitting shoulder-to-shoulder with dispatchers stuck optimizing massive boards with sticky notes and instinct."`}
    />
